"""
Meddpicc Framework Tracking Skill
"""
...
class MeddpiccSkill(BaseSkill):
    ...
    async def generate(self, account_name: str, **kwargs) -> str:
        ...
        # Build prompt
        prompt = f"""Generate meddpicc framework tracking for {account_name}.
...
Create a comprehensive meddpicc framework tracking that:
