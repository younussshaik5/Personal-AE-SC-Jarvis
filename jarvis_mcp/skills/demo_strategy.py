"""
Demo Narratives And Flows Skill
"""
...
class DemoStrategySkill(BaseSkill):
    """Demo narratives and flows"""

    async def generate(self, account_name: str, **kwargs) -> str:
        """
        Generate demo_strategy.
        ...
        # Build prompt
        prompt = f"""Generate demo narratives and flows for {account_name}.
...
Create a comprehensive demo narratives and flows that:
