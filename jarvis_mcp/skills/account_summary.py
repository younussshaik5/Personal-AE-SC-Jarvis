...
class AccountSummarySkill(BaseSkill):
    ...
    async def generate(self, account_name: str, **kwargs) -> str:
        ...
        # Build prompt
        prompt = f"""Generate account executive summary for {account_name}.
...
Create a comprehensive account executive summary that:
